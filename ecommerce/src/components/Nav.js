...
const Nav = () => {
    ...
    const Nav = styled.nav`
        ...
        @midea(max-width: ${({theme}) => theme.midea.mobile}) {
            .mobile-navbar-btn {
                display: inline-block;
                z-index:9999;
    ...
    <Nav>
        <div className='{menuIcon ? "navbar active" : "navbar"}'>
            <ul className="navbar-lists">
                ...
                <li><NavLink to="/about" className="navbar-link home-link">About</NavLink></li>
                <li><NavLink to="/products" className="navbar-link home-link">Products</NavLink></li>
                <li><NavLink to="/contact" className="navbar-link home-link">Contact</NavLink></li>
                <li>
